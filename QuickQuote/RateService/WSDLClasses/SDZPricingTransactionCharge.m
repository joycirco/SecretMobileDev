/*
	SDZPricingTransactionCharge.h
	The implementation of properties and methods for the SDZPricingTransactionCharge object.
	Generated by SudzC.com
*/
#import "SDZPricingTransactionCharge.h"

#import "SDZEffectivePricing.h"
@implementation SDZPricingTransactionCharge
	...
	- (id) init
	{
		if(self = [super init])
		{
			...
			self.max_dollar = nil;
			self.effectivePricing = nil; // [[SDZEffectivePricing alloc] init];

		}
		return self;
	}

	+ (SDZPricingTransactionCharge*) createWithNode: (CXMLNode*) node
	{
	...
	- (id) initWithNode: (CXMLNode*) node {
		if(self = [super initWithNode: node])
		{
			...
			self.effectivePricing = [[SDZEffectivePricing createWithNode: [Soap getNode: node withName: @"effectivePricing"]] object];
		}
		return self;
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[SDZPricingTransactionCharge class]]) {
