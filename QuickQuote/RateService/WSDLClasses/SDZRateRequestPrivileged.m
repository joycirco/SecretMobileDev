/*
	SDZRateRequestPrivileged.h
	The implementation of properties and methods for the SDZRateRequestPrivileged object.
...
@implementation SDZRateRequestPrivileged
	...
	- (id) init
	{
		if(self = [super init])
		{
			...
			self.reqStopOffs = [[[NSMutableArray alloc] init] autorelease];
			self.reqParcelPackCode = nil;
			self.reqParcelAccountNumber = nil;
			self.reqFreight = [[[NSMutableArray alloc] init] autorelease];
			self.reqPalletPositions = [[[NSMutableArray alloc] init] autorelease];
			self.reqPickupDate = nil;
			self.reqDropDate = nil;
			self.reqAccessorials = [[[NSMutableArray alloc] init] autorelease];
			self.reqAccessorialRateOverrides = [[[NSMutableArray alloc] init] autorelease];
			self.reqScacFilter = nil; // [[SDZCarrierScacs alloc] init];
	...
	+ (SDZRateRequestPrivileged*) createWithNode: (CXMLNode*) node
	{
	...
	- (id) initWithNode: (CXMLNode*) node {
		if(self = [super initWithNode: node])
		{
			...
			self.reqStopOffs = [[SDZArrayOfStopOff createWithNode: [Soap getNode: node withName: @"reqStopOffs"]] object];
			...
			self.reqFreight = [[SDZArrayOfFreight createWithNode: [Soap getNode: node withName: @"reqFreight"]] object];
			...
			self.reqPalletPositions = [[SDZArrayOfPalletPositions createWithNode: [Soap getNode: node withName: @"reqPalletPositions"]] object];
			...
			self.reqAccessorials = [[SDZArrayOfAccessorial createWithNode: [Soap getNode: node withName: @"reqAccessorials"]] object];
			self.reqAccessorialRateOverrides = [[SDZArrayOfAccessorialRateOverride createWithNode: [Soap getNode: node withName: @"reqAccessorialRateOverrides"]] object];
			self.reqScacFilter = [[SDZCarrierScacs createWithNode: [Soap getNode: node withName: @"reqScacFilter"]] object];
	...
	- (NSMutableString*) serializeElements
	{
		...
		if (self.reqStopOffs != nil && self.reqStopOffs.count > 0) {
			[s appendFormat: @"<reqStopOffs>%@</reqStopOffs>", [SDZArrayOfStopOff serialize: self.reqStopOffs]];
		} else {
		...
		if (self.reqFreight != nil && self.reqFreight.count > 0) {
			[s appendFormat: @"<reqFreight>%@</reqFreight>", [SDZArrayOfFreight serialize: self.reqFreight]];
		} else {
		...
		if (self.reqPalletPositions != nil && self.reqPalletPositions.count > 0) {
			[s appendFormat: @"<reqPalletPositions>%@</reqPalletPositions>", [SDZArrayOfPalletPositions serialize: self.reqPalletPositions]];
		} else {
		...
		if (self.reqAccessorials != nil && self.reqAccessorials.count > 0) {
			[s appendFormat: @"<reqAccessorials>%@</reqAccessorials>", [SDZArrayOfAccessorial serialize: self.reqAccessorials]];
		} else {
			[s appendString: @"<reqAccessorials/>"];
		}
		if (self.reqAccessorialRateOverrides != nil && self.reqAccessorialRateOverrides.count > 0) {
			[s appendFormat: @"<reqAccessorialRateOverrides>%@</reqAccessorialRateOverrides>", [SDZArrayOfAccessorialRateOverride serialize: self.reqAccessorialRateOverrides]];
		} else {
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[SDZRateRequestPrivileged class]]) {
	...
	- (void) dealloc
	{
		...
		self.reqDestWarehouseCode = nil;
		self.reqRoutingCustomerCode = nil;
		self.reqStopOffs = nil;
		self.reqParcelPackCode = nil;
		self.reqParcelAccountNumber = nil;
		self.reqFreight = nil;
		self.reqPalletPositions = nil;
		self.reqPickupDate = nil;
		self.reqDropDate = nil;
		self.reqAccessorials = nil;
		self.reqAccessorialRateOverrides = nil;
		self.reqScacFilter = nil;
		self.reqAuditAmount = nil;
		self.reqHours = nil;
		self.reqShipmentValue = nil;
		self.reqNmfcCodes = nil;
